...
- Do not approve protected-environment deployment reviews programmatically; the repository owner reviews each pending deployment in GitHub.
...
- [ ] **Step 1: Prove the two target groups are absent and production is outside scope**
...
- [ ] **Step 2: Create the two explicitly named containers**
...
- [ ] **Step 3: Verify only the intended groups changed**
...
- [ ] **Step 1: Dispatch the existing workflow from the promotion branch**
...
- [ ] **Step 2: Owner reviews each GitHub environment approval**

Review the `preview_foundation`, `prepare_release`, and `deploy_release` approvals in GitHub. Do not approve them with automation. Confirm each completed job summary before approving its successor.

- [ ] **Step 3: Verify the resulting Azure identity and live endpoint**
...
- [ ] **Step 4: Run final reset audit and commit evidence**
